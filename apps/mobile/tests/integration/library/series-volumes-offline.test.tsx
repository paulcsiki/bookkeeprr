...
function renderVolumes() {
  return render(<ThemeProvider><AuthProvider><SeriesVolumes /></AuthProvider></ThemeProvider>);
}
...
it('offline tablet (volumes-split): renders the offline state in the split', async () => {
