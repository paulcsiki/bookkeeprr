  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          // 36px control per design system §08 (Forms & dialogs).
          // `truncate` forces single-line ellipsis on overflow (e.g. long
          // OIDC discovery URL) so the row never wraps and grows.
