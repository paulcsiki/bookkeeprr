...
import {
  ...
  clampPan,
  type Pan,
} from '@/components/reader/lib/zoom';
...
describe('reader zoom math', () => {
  ...
  describe('clampPan', () => {
    ...
    it('clamps each axis to its half-overflow bound', () => {
      // content 800x1200 → bounds 200x300
