...
// Safari-style browser window — ported from
// docs/design/handoff-2026-06-01/bookkeeprr/project/browser-window.jsx.
// No assets, all inline styles + inline SVG.
...
function ChromeTrafficLights(): JSX.Element {
  return (
...
function ChromeTab({
  ...
  return (
    ...
    >
      ...
      {active && curve(true)}
      <div
        style={{ width: 14, height: 14, borderRadius: '50%', background: '#5f6368', flexShrink: 0 }}
      />
      <span
        style={{
          flex: 1,
...
function ChromeToolbar({ url = 'example.com' }: { url?: string }): JSX.Element {
  const iconDot = (
    <div
      style={{
        width: 28,
